...
from experiment3 import graph, start, end, generations, agents_list, rho_list

import pylab
import networkx as nx


db = Connection()['alos-experiment3']
...
for rho in rho_list:
    for agents in agents_list:
        ...
        fig.savefig('fitness_{0}_{1}.pdf'.format(agents, friendly_rho))
        ...
        pylab.savefig('pheromones_{0}_{1}.pdf'.format(agents, friendly_rho))
